...
public class GestureRotationController : MonoBehaviour
{
    ...
    public void StartRotating()
    {
        ...
        _thumbThimbleHaptic.AddEffect(_gestureEffect);
        _indexThimbleHaptic.AddEffect(_gestureEffect);
        _middleThimbleHaptic.AddEffect(_gestureEffect);
    }
    ...
    public void StopRotating()
    {
        if (_isRotation)
        {
            _thumbThimbleHaptic.RemoveEffect(_gestureEffect);
            _indexThimbleHaptic.RemoveEffect(_gestureEffect);
            _middleThimbleHaptic.RemoveEffect(_gestureEffect);
        }
